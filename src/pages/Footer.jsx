const Footer = () => {
  return (
    <section className="">
      <div className="bg-[#5C3EAF] bg-opacity-30 ">
        <div className="max-w-[1600px] mx-auto">
          <div className="px-8 lg:px-32 md:px-20 lg:pt-20 lg:pb-20 pt-10 pb-10 mt-10 md:grid grid-cols-4 lg:grid-cols-3 items-center gap-x-10 lg:items-start">
      ...
      <div className="bg-[#5C3EAF]">
        <div className="max-w-[1600px] mx-auto">
          <div className="py-5 md:px-20 lg:px-32 text-white px-8 md:flex justify-between">
            <h1 className="font-medium">
              © 2023 Mahyu.my.id | Azam Din Abdillah
            </h1>
